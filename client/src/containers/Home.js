...
class Home extends Component {
    ...
    recommendLink(){
//        return this.props.loggedInUser ? (on <a onClick={() => this.goToPage('/new-practitioner')}>“Recommend”</a> and follow instructions.) : ''
    }
    render() {
        ...
        return (
            <div className='container left home' >
                ...
                <ul className='list'>
                    <li>
                    Medical Doctors and other health care providers who may have a little or alot or knowledge about ME and/or fibromyalgia;
                    </li>
                    <li>
                ...
                <ol className='list'>
                    ...
                    {this.props.loggedInUser ? 
                        ...
                        : <> on <a>“Recommend”</a>  and follow instructions.</>}
                    </li>
                </ol>
